...
// Task 5.
// С помощью alert выведите результат операции:    2019 - 200
//alert(2019 - 200);
...
document.querySelector('.four').innerHTML += ('<h4>Some h4<p>Some paragraph</p></h4>');
...
let z1 = 6;
let z2 = 3;
let z3 = document.querySelector('.task14').innerHTML = z1 * z2;
