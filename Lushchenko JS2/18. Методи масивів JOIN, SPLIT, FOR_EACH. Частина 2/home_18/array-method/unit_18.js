...
function t3() {
    ...
    let out = a3.forEach(elem => { if (!isNaN(elem)) a3_res.push(elem) });
...
function t4() {
    ...
    let out = span.forEach(elem => a4_res.push(elem.getAttribute('data')))
...
function t6() {
    let str6 = 'helloworld';
    document.querySelector('.out-6').innerHTML = str6.split('');
...
function t7() {
    ...
    document.querySelector('.out-7').innerHTML = str7.split(' ');
}
...
function t9() {
    ...
    let arr = a9.reduce((acum, elem) => acum.concat(elem)).join('-');
...
function t10() {
    ...
    let obj = Object.entries(a10).reduce((acum, elem) => acum.concat(elem)).join('-');
    document.querySelector('.out-10').innerHTML = obj;
